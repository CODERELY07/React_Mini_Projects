...
import { challenge2 } from '../../data/challengeCode/challenge2';
...
const Challenge2 = () => {
  ...
  return (
    <div className="min-h-screen py-5 bg-gray-100 flex flex-col items-center justify-center"  >
      <Task/>
        <div className="max-w-[1200px] mt-5 w-full bg-white p-2 md:p-8 rounded-2xl shadow-lg space-y-6">
        <h1>Output:</h1>
        <Filter 
